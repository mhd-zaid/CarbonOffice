...
final class Version20230727142810 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dispense (id INT NOT NULL, mentor_id INT DEFAULT NULL, date DATE NOT NULL, start_time DATE NOT NULL, link VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
